...
migration_mv_zpro() {
  print_banner
  printf "${WHITE} 💻 Agora, vamos mover a migration até o deployplw...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  sudo su - root <<EOF
  cp "${PROJECT_ROOT}"/zpro.zip /home/deployplw/
  mv /home/deployplw/izing.io /home/deployplw/zpro.io
EOF
